...
| `03-performance.html` | Performance | Spend, DemandSense verified. Google and LinkedIn separated, funnel stage by channel, campaign detail |
...
| `07-ecosystem.html` | Ecosystem | The marketing hierarchy. 22 motions across 5 floors, EMS 15/100, gated on conversion tracking |
| `08-next90.html` | Next 90 | 14 moves, 3 CUT / 3 SCALE / 4 BUILD / 4 TEST, budget arc, commitment log |

## Canonical figures
- **Spend, DemandSense verified:** LinkedIn $14,473.64 (1 May to 28 Jul, 89d) · Google $3,932.69 (17 Jun to 28 Jul, 42d). **Windows differ and are never summed.**
...
- **EMS 15/100, stage Validate.** Floor hierarchy: the account is gated on conversion tracking, the one missing foundation motion.
